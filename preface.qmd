...
Water chemistry data used in this tutorial include published data [@mcgovern2020terrestrial] and generated data for teaching purposes. This tutorial was created using [Quarto](https://quarto.org).
:::
